	...
	async function authenticate() {
		try {
			...
			const authUrl = `https://accounts.spotify.com/authorize?client_id=41ee2d3de3104070ba48a81212e550eb&response_type=token&redirect_uri=${encodeURIComponent(
                redirectUri
            )}&scope=user-read-email%20user-library-read%20user-read-recently-played%20user-top-read%20playlist-read-private%20playlist-read-collaborative%20playlist-modify-public%20user-modify-playback-state%20user-read-playback-state`;
